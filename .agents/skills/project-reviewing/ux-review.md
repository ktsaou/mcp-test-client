...
1. **Spawn the UX-critic template** from [`../project-maintainer/agents-roster.md`](../project-maintainer/agents-roster.md).
2. **Provide:**
   - The live URL (or local dev build URL).
   - A link to [`../../sow/specs/quality-bar.md`](../../sow/specs/quality-bar.md)
...
- Share-link reload in a fresh incognito tab — **explicitly verify the
  ...
  [`../../sow/specs/values.md`](../../sow/specs/values.md)'s "share a reproducible tool call"
  promise.**
...
- **2026-04-25 — Prompt scope was too narrow.** The critic's
  ...
  [`../project-maintainer/agents-roster.md`](../project-maintainer/agents-roster.md), and listed above.
- **2026-04-25 (later) — "Share-link reload" was too vague.** Without
  ...
  [`../../sow/specs/values.md`](../../sow/specs/values.md) promises tool-call restoration. The
