...
| [DEC-012](DEC-012-v1-1-1-log-redesign.md)        | v1.1.1: "the log, fixed"                                           | 2026-04-25           | Open      | Method-summary headline, collapse/expand, prev/next nav, always-visible copy/save, metrics chips. |
