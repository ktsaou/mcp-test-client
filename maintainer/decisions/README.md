...
| [DEC-016](DEC-016-onboarding-and-connection-ergonomics.md) | v1.1.12 + v1.1.14: onboarding + connection ergonomics              | 2026-04-25           | Closed    | Click-to-connect (v1.1.12), cancel inflight (v1.1.12), URL-driven add (v1.1.14), connect-on-save + required auth (v1.1.14).             |
...
| [DEC-019](DEC-019-send-without-validation.md)              | v1.1.16: send without validation                                   | 2026-04-25           | Closed    | Shipped as v1.1.16; Send gated on schema validation, chevron menu reveals "Send without validation"; per-send only.                     |
| [DEC-020](DEC-020-inflight-status-bar.md)                  | v1.1.19: inflight activity indicator                               | 2026-04-25           | Partial   | v1.1.19 shipped visibility (count + popover with method/elapsed). Cancel UI deferred to v1.2 (needs SDK AbortController plumbing).      |
| [DEC-021](DEC-021-settings-portability.md)                 | v1.1.18: settings portability (export / import)                    | 2026-04-25           | Closed    | Shipped as v1.1.18; gear-icon menu in header, "Include credentials" toggle, full mcptc:\* key round-trip.                               |
