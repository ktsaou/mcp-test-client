...
| [DEC-023](DEC-023-llm-chat-test-this-mcp.md)               | v1.3.0: "Test this MCP" with an LLM chat                           | 2026-04-25           | Gated     | Browser-direct LLM + MCP tool-call bridge; gated on CORS feasibility research.             |
