...
| [DEC-012](DEC-012-v1-1-1-log-redesign.md)          | v1.1.1: "the log, fixed"                                           | 2026-04-25           | Open (12.5/13) | 12.5 of 13 rows pass; notification-row consistency carries to DEC-013.                     |
| [DEC-013](DEC-013-notification-row-consistency.md) | Notification rows render as full collapsible entries               | 2026-04-25           | Open           | Patch DEC-012 rows 7/8/12 for the `notifications/*` row class.                             |
