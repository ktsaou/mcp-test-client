...
2. **Pick the advisor template** from [`../agents.md`](../agents.md).
...
4. **Capture the advisor's verdict in the relevant DEC file**, not in the
   log only. The log records the event; the DEC records the conclusion.
...
- **2026-04-25 — Incomplete UX-critic prompt.** The first UX-critic
  ...
  template by default; see [`ux-review.md`](ux-review.md) for the
  expanded checklist.
